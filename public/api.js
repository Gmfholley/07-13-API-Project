...
// returns a form with an id of form and with an action of /class_name/submit
//
// returns a form
...
// creates HTML for an object and this property (an input and a label and adds it to the form)
//
// returns nothing
function create_HTML_for_object_response(object, property){
  ...
  var input = document.createElement("input");
  input.setAttribute("type", "text");
  input.setAttribute("name", 'return_form[' + property + ']');
...
// changes the value of the input Element of this class to this object's parameter of same name
//
// obj - Object
...
// changes the value of the Element of this class to this object's parameter of same name
//
// obj - Object
// parameter - String - to make it a duck type with other functions, this is irrelevant
//
// returns nothing
...
// remove all Children for this id
//
// id - String of the Element's id
//
// returns nothing
...
///////////////////////////////////////////////////////////////////////////      
// clears the message, creates a new XML Http Request
// fetches all of the objects for the selected class
// and creates a selector of those objects and posts to the DOM
//
// returns nothing
...
// creates XML Http Request to delete the selected object
// if successfully deleted, posts all records
// if not deleted, clears response area and posts message
//
// returns nothing
...
/////////////////////////////////////////////////////////////////////////////////
// Create-Update Tab Event Listener
///////////////////////////////////////////////////////////////////////////////

// puts this response into the json-response div
...
function request_json_and_fill_in_object_fields(){
    ...
    request.addEventListener("loadstart", show_loading_gif(document.getElementById("json-response")));
    request.addEventListener("load", create_HTML_for_object_response);
    request.send();
}

// Requests an object with id of 0 so that it can get all of the object's parameters
// Takes those parameters and makes HTML elements - input fields for parameters and selectors for Foreign Keys
//
// returns nothing
...
// creates XML HttpRequest and submits the current object to server
// if successful, clears the input Elements
// if not successful, shows error message
//
// returns nothing
function submit_form_using_ajax(event){
  ...
  kvpairs.push("return_form[id]=" + document.getElementById("input-id").value);
...
// creates a selector for class, requests an object for parameters, and creates HTML elements for the first class and a submit button
//
// returns nothing
function create_or_update_interface(){
  ...
  content.appendChild(return_form());
  add_message_to_form();
...
// creates a selector for class, loads a selector of all that class's objects, and creates delete button
//
// returns nothing
...
//////////////////////////////////////////////////////////////////////////////////////////////////
// Window onload events - add create, show, delete tab event listeners and start by clicking show
//
/////////////////////////////////////////////////////////////////////////////////////////////////
